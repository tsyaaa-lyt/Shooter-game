...
class Enemy(GameSprite):
    ...
    def update(self):
        ...
        global lost
        #dissapears if it reaches the edge of the screen
...
while run:
    ...
    if not finish:
        ...
        # bullet-monster collision check (both monster and bullet dissappear upon touching)
        collides = sprite.groupcollide(monsters, bullets, True, True)
        for c in collides:
            #this loop will be reposted as many times as monsters are killed
            score = score + 1
            monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, randint(1, 5))
            monsters.add(monster)
